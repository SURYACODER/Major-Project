...
st.set_page_config(
    page_title="Knee osteoarthritis detection and severity prediction",
    page_icon=icon,
)
...
with st.sidebar:
    st.image(icon)
    st.subheader("Main Project 2023")
    st.caption("Team Number 48")
...
# Body
st.header("Knee OA Detection and Severity Prediction")
